...
ggsurvplot(fit2, data = a_data, pval = TRUE, conf.int = TRUE, xlab="Time (Months)")
```
...
summary(fit3)
ggsurvplot(fit3, data = a_data, pval = TRUE, conf.int = TRUE, palette=c("blue", "red","green"), xlab="Time (Months)")
```
...
summary(fit4)
ggsurvplot(fit4, data = a_data, pval = TRUE, conf.int = TRUE, xlab="Time (Months)")
```
...
summary(fit5)
ggsurvplot(fit5, data = a_data, pval = TRUE, conf.int = TRUE, legend.labs = c("author count <= 20", "author count > 20"), xlab="Time (Months)")
```
...
summary(fit6)
ggsurvplot(fit6, data = a_data, pval = TRUE, conf.int = TRUE, legend.labs = c("rev. per day <= 1", "rev. per day > 1"), xlab="Time (Months)")
```
