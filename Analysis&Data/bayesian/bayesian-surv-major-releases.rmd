---
title: "Bayesian survival analysis using major releases as a predictor"
...
exp_surv_model_survival <-
    ...
    mutate(treatment = factor(treatment, # treatment is whether or not project has major releases
                              levels = c("s1","s0"),
                              labels = c("major_releases_true","major_releases_false")))
