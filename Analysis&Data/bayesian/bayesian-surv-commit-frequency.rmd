...
exp_surv_model_survival <-
    ...
    mutate(treatment = factor(treatment, # treatment is whether or not projects have high commit frequency
                              levels = c("s1","s0"),
                              labels = c("high_commit_freq_true","high_commit_freq_false")))
